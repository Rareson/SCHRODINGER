...
%> There are a number of choices for the  potential and you can easily define
%> more of them. Note that the results do tend to give little more 
%> than random waves sloshing about unless the spectrum is almost harmonic. 
%>
...
' ' 
' There are a number of choices for the  potential. Note that the' 
' long time evolutios tends to give little more than random waves ' 
' sloshing about unless the spectrum is almost harmonic. ' };
